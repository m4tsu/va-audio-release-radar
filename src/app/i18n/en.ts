...
export const en: Translations = {
  ...
  admin: {
    ...
    unmatchedExclude: "Mark as not tracked",
    unmatchedExcluding: "Marking…",
    unmatchedExcludeError: "Could not mark as not tracked",
    excludedTitle: "Names marked as not tracked",
    excludedSummary: {
      one: "{{count}} name. Removing the mark returns it to the unmatched queue.",
      other: "{{count}} names. Removing the mark returns them to the unmatched queue.",
    },
    excludedEmpty: "No name is marked as not tracked.",
    excludedSince: "Marked on {{date}}",
    excludedRestore: "Remove mark",
    excludedRestoring: "Removing…",
    excludedRestoreError: "Could not remove the mark",
