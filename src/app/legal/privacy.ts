        ...
        blocks: [
          {
            ...
            items: [
              ...
              "上記のアフィリエイトの成果計測を除き、本サービスはアクセス解析ツールや広告配信のためのタグ、SNS の埋め込みを使用していません。",
            ],
          },
        ],
      },
        ...
        blocks: [
          {
            ...
            items: [
              ...
              "Apart from the affiliate measurement described above, the Service does not use analytics tools, advertising tags or social media embeds.",
            ],
          },
        ],
      },
