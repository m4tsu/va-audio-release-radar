    ...
    sections: [
      {
        ...
        blocks: [
          {
            type: "paragraph",
            text: "この利用規約 (以下「本規約」) は、Koetrail (以下「本サービス」) の利用条件を定めるものです。本サービスを利用する方 (以下「利用者」) は、本規約に同意したうえで本サービスを利用するものとします。",
          },
          {
            type: "paragraph",
    ...
    sections: [
      {
        ...
        blocks: [
          {
            type: "paragraph",
            text: 'These Terms of Service (the "Terms") set out the conditions for using Koetrail (the "Service"). By using the Service, you (the "User") agree to be bound by these Terms.',
          },
          {
            type: "paragraph",
