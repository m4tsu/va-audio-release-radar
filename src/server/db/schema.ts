...
export const voiceActors = sqliteTable(
  "voice_actors",
  {
    ...
    /**
     * かなを外から引きに行った日時。取れても取れなくても入る。
     *
     * 「まだ引いていない人」と「引いたが取れなかった人」を分けるために持つ。分けないと、
     * 記事が無い声優を毎週引き直すことになる。日時にしてあるのは、記事が後からできた人を
     * 「この日より前に引いた人」で選び直せるようにするため。
     * 付加情報の表に入れないのは、これが画面に出す値ではなく取得の記録だから
     */
    nameKanaCheckedAt: text("name_kana_checked_at"),
    /**
